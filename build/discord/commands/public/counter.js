...
function counterMenu(current) {
    const container = createContainer("Random", createSection(`## Current value: \` ${current} \``, new ButtonBuilder({
        customId: `counter/00`,
        label: "Reset",
        disabled: current === 0,
        style: current > 0 ? ButtonStyle.Primary :
            current < 0 ? ButtonStyle.Danger :
                ButtonStyle.Secondary
    })), Separator.Default, createSection("Increment value", new ButtonBuilder({
