...
createCommand({
    ...
    async run(interaction) {
        ...
        }), Separator.Default, "### <:shield_check:1502789932727668788> Comandos da Equipe", [
        ...
        ].join("\n"), Separator.Default, "### <:other_terminal:1502789958430232688> Comandos Públicos", [
            `<:action_question:1502789799969296454> \`/help\` — Mostra esta mensagem`,
        ].join("\n"), Separator.Default, "### <:action_warning:1502789801949265990> Status e Prioridade", "Ao alterar o status do pedido, o ticket é reposicionado automaticamente na categoria por ordem de prioridade (Pagamento > Produção > Aberto > Fila > Concluído).", Separator.Default, "### <:other_megaphone:1502789956312236092> Dúvidas?", "Caso precise de suporte, contate um membro da equipe.");
