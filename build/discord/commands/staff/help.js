...
createCommand({
    ...
    async run(interaction) {
        ...
        }), Separator.Default, `### ${getEmojiTag("other_ticket")} Atendimento\nPara abrir um ticket, utilize os **botões / menus** do painel de atendimento configurado pela equipe e escolha a categoria do seu assunto.`, Separator.Default, `### ${getEmojiTag("other_dollar")} Pagamentos\n${pagamentos}`, Separator.Default, `### ${getEmojiTag("shield")} Sistema & Moderação\n${sistema}`, Separator.Default, `*Precisa de ajuda? Abra um ticket pelo painel de atendimento — a equipe vai te atender!*`);
