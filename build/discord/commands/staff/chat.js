...
createCommand({
    name: "bloquear-chat",
    description: "Bloqueia o chat atual para que apenas administradores possam enviar mensagens.",
...
createCommand({
    ...
    description: "Desbloqueia o chat atual para que todos possam enviar mensagens.",
    type: ApplicationCommandType.ChatInput,
    defaultMemberPermissions: PermissionFlagsBits.ManageChannels,
    async run(interaction) {
        if (!interaction.inCachedGuild())
