 ...
 *
 * A resolução é feita pelo header Host da requisição: cada cópia do bot aponta
 * seu WEB_URL para um domínio diferente, e a env var TENANTS mapeia domínio -> tenant.
 */
